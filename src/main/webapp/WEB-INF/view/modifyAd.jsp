...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-8">
				<c:if test="${cancelOrAppend =='true'}">
					<form enctype="multipart/form-data" action="uploadModify.do"
						method="POST">
						<div class="panel panel-default" id="headings">
						...
						<div class="alert alert-warning">Sono gia' presenti foto allegati a questo annuncio...</div>
						<div class="col-lg-4">
							<!-- onclick="return validation()" -->
							<button class="btn btn-lg btn-primary btn-block" id="appendFoto" name="appendFoto" value="A">Aggiungi ad esistenti</button>
						</div>
						<div class="col-lg-4">
							<!-- onclick="return validation()" -->
							<button class="btn btn-lg btn-primary btn-block" id="cancellaFoto" name="deleteFoto" value="D">Cancella precendenti</button>
						</div>
						
						<div class="col-lg-4">
							<!-- onclick="return validation()" -->
							<button class="btn btn-lg btn-primary btn-block" id="noFoto" name="noFoto" value="N">Non aggiungere</button>
						</div>
						
						<div class="form-group" style="display: none;">
								<input class="form-control" type="text" id="actionFoto" name="actionFoto">
						</div>
					</form>
				</c:if>
			</div>
...
<script>
	...
	$("#appendFoto").click(function() {
		$('#actionFoto').val($("#appendFoto").val());
		
	});
	
	$("#deleteFoto").click(function() {
		$$('#actionFoto').val($("#deleteFoto").val());
		
	});
	
	$("#noFoto").click(function() {
		$('#actionFoto').val($("#noFoto").val());
